...
model = dict(
    ...
    rbox_head=dict(
        ...
        loss_odm_cls=dict(
            ...
            alpha=0.25,
            loss_weight=1.0),
        loss_odm_bbox=dict(type='SBDLoss', loss_weight=0.5))
        )
...
data = dict(
    ...
    test=dict(
        ...
        pipeline=test_pipeline))
# optimizer
optimizer = dict(type='Adam', lr=5e-5, betas=(0.9, 0.999), eps=1e-08, weight_decay=0)
...
log_level = 'INFO'
work_dir = './work_dirs/cascade_retinanet_quad_r50_fpn_sbd_416_hrsc2016/'
load_from = './work_dirs/cascade_retinanet_quad_r50_fpn_sbd_416_hrsc2016/epoch_100.pth'
resume_from = None
workflow = [('train', 1)]