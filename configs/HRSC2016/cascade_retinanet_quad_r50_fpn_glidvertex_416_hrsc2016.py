...
model = dict(
    ...
    neck=dict(
        ...
        num_outs=5),
    rbox_head=dict(
        type='QuadCasRetinaGlindVertexHead',
        num_classes=2,
        in_channels=256,
        stacked_convs=4,
        feat_channels=256,
        ...
        loss_odm_cls=dict(
            ...
            alpha=0.25,
            loss_weight=1.0),
        loss_odm_bbox=dict(type='GlidingLoss', loss_weight=1.0))
        )
...
log_level = 'INFO'
work_dir = './work_dirs/cascade_retinanet_quad_r50_fpn_glidvertex_416_hrsc2016/'
load_from = None
resume_from = None
workflow = [('train', 1)]