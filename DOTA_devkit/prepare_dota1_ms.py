...
def prepare_multi_scale_data(src_path, dst_path, gap=512, subsize=1024, scales=[0.5, 1.0, 1.5], num_process=32):
...
if __name__ == '__main__':
    # single scale
    prepare_multi_scale_data('/data-input/RotationDet/data/dota',
                             '/data-input/RotationDet/data/dota_800',
                                gap=200, subsize=800, 
                                scales=[1.0])
    # multi scale
    # prepare_multi_scale_data('/data-input/RotationDet/data/dota',
    #                          '/data-input/RotationDet/data/dota_1024_ms',
    #                          scales=[0.5, 1.0, 1.5], gap=512,subsize=1024)
    print('done')
