...
model = dict(
    ...
    rbox_head=dict(
        ...
        loss_odm_cls=dict(
            ...
            alpha=0.25,
            loss_weight=1.0),
        loss_odm_bbox=dict(type='HungarianLoss',form ='obb', loss_weight=0.2))
        )
...
# dataset settings
dataset_type = 'MSRA_TD500Dataset'
...
log_level = 'INFO'
work_dir = './work_dirs/cascade_retinanet_obb_r50_fpn_hungarian_800_msra_td500/'
load_from = None
resume_from = None
workflow = [('train', 1)]