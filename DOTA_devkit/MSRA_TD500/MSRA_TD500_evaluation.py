...
def eval_MSRA_TD500(dets_dir, eval_dir):
    zip_name = 'submit.zip'
...
def parse_args():
    parser = argparse.ArgumentParser(description='MSRA-TD500 evaluation')
...
if __name__ == '__main__':
    ...
    eval_MSRA_TD500(dets_dir, 'DOTA_devkit/MSRA_TD500/eval')
