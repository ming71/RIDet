...
model = dict(
    ...
    rbox_head=dict(
        ...
        loss_ref=dict(type='SmoothL1Loss', loss_weight=1.0),
        loss_odm_cls=dict(
            type='FocalLoss',
            use_sigmoid=True,
            gamma=2.0,
            alpha=0.25,
            loss_weight=1.0),
        loss_odm_bbox=dict(type='HungarianLoss',form ='obb', loss_weight=5.0))
        )
...
log_level = 'INFO'
work_dir = './work_dirs/cascade_retinanet_obb_r101_fpn_hungarian_800_hrsc2016/'
load_from = './work_dirs/cascade_retinanet_obb_r101_fpn_hungarian_800_hrsc2016/pretrain_10epoch.pth'
resume_from = None
workflow = [('train', 1)]