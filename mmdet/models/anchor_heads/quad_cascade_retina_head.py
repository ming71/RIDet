...
class QuadCasRetinaHead(nn.Module):
    ...
    def __init__(self,
                 ...
                 loss_odm_bbox=dict(
                     type='SmoothL1Loss', beta=1.0 / 9.0, loss_weight=1.0)):
        super(QuadCasRetinaHead, self).__init__()
    ...
    def loss_odm_single(self,
        ...
        odm_bbox_pred = odm_bbox_pred.permute(0, 2, 3, 1).reshape(-1, 8)
        if cfg.get('calc_offset') == False:
            refine_anchors = refine_anchors.reshape(-1, 5)
            decode_bboxes = delta2quad(refine_anchors, odm_bbox_pred)
    ...
    def get_bboxes_single(self,
        ...
        for cls_score, bbox_pred, anchors in zip(cls_score_list,
            ...
            quads = delta2quad(anchors, bbox_pred, self.target_means,
                                self.target_stds)
